...
<head>
    ...
    <title>Poli Paru-Paru | Puskesmas</title>
    ...
    <div id="container" class="container-fluid text-center">
        <div class="w-75 d-flex flex-row mx-auto card m-3 p-2 pb-5" style="background-color: #9DB69B !important;">
            ...
            <div class="row mt-2 pt-5">
                <img class="col-8 w-50 mx-auto m-2 shadow" src="<?= $main_url?>assets/img/login/dr2.jpg" width="150" alt="" style="border-radius: 10px !important;">
                <h1 class="col-12 w-100 mx-auto pt-2 pb-1">
                    dr.Tommy Irawan, Sp.P
                </h1>
            </div>
            <div class="mainContentPendf w-100 m-2 pe-3 pt-5" >
                <div class="card p-3 pt-5 shadow" style="border-radius: 15px;">
                    <h4>Daftar Poli Paru-Paru</h4>
                    <form action="">
                    <div class="mb-3 pb-3">
                        <div class="mb-3">
